...
if ticker:
    ...
    if dcf_data and ratios_data:
        ...
        st.write(f"**P/E Ratio**: {ratios_data.get('priceEarningsRatio', 'N/A')}")
        ...
        stock_sector = ratios_data.get("sector", "Unknown")
        sector_pe = sector_pe_data.get(stock_sector)
        ...
        if stock_pe and sector_pe:
            ...
            with col4:
                st.metric(f"{stock_sector} Sector P/E", f"{sector_pe:.2f}")
